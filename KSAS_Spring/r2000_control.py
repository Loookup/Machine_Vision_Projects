...
class r2000_control:
    def __init__(self):
        ...
        # Set up subscribers.
        # self.th1_sub = rospy.Subscriber("/r2000_description/joint_1_pc/state", JointControllerState, self.callback, queue_size=1)
        # self.th2_sub = rospy.Subscriber("/r2000_description/joint_2_pc/state", JointControllerState, self.callback, queue_size=1)
        # self.th3_sub = rospy.Subscriber("/r2000_description/joint_3_pc/state", JointControllerState, self.callback, queue_size=1)
        # self.th4_sub = rospy.Subscriber("/r2000_description/joint_4_pc/state", JointControllerState, self.callback, queue_size=1)
        # self.th5_sub = rospy.Subscriber("/r2000_description/joint_5_pc/state", JointControllerState, self.callback, queue_size=1)
        # self.th6_sub = rospy.Subscriber("/r2000_description/joint_6_pc/state", JointControllerState, self.callback, queue_size=1)
        ...
        self.th6_2_pub = rospy.Publisher("/r2000_description/joint_6_2_vc/command", Float64, queue_size=1)

        self.publisher(0,0,0,0,0,0, 0.1)
    ...
    def publisher(self, th1, th2, th3, th4, th5, th6, th6_2):
        ...
        self.th6_2_pub.publish(th6_2_m)
...
if __name__ == "__main__":
    try:
        ...
        while not rospy.is_shutdown():
            ...
            r2000_c.publisher(0, 0, 0, 0, 0, 0, 0.5)
